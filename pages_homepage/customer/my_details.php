...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="my_sessions.php">My sessions</a>
            </li>
            <li class="nav-item">
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT * FROM customer WHERE customer_id = :customerId");
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                ...
                                                <p class="form-control form-control-alternative"><?php echo $customerDetails['c_name']; ?></p>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                <label for="input-last-name">My ID</label>
                                                <p class="form-control form-control-alternative"><?php echo $customerDetails['customer_id']; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                <label for="input-first-name">Birth date</label>
                                                <p class="form-control form-control-alternative"><?php echo $customerDetails['birth_date']; ?></p>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="input-email">Contact</label>
                                                <p class="form-control form-control-alternative"><?php echo $customerDetails['contact']; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
